...
const Header: React.FC = () => {
  return (
    <header 
      className="header-gradient text-[var(--color-neutral-offwhite)] p-4 md:p-6 shadow-md sticky top-0 z-50 backdrop-blur-sm bg-opacity-90"
    >
      <div className="container flex justify-between items-center">
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-[var(--color-neutral-offwhite)] tracking-tight">
            RoboCode <span className="text-base md:text-lg font-medium opacity-80">Platform</span>
          </h1>
        </div>
